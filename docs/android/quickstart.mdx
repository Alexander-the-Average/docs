...
To get started quickly, you can use our sample code available in the [Android UI Kit Sample App GitHub repository](https://github.com/dyte-io/android-samples/tree/main/samples/android-ui-kit-sample-kotlin). 
Clone and run the sample application to see the SDK in action.
...
<head>
  ...
  <meta name="description" content="Dive into Dyte's Android documentation to integrate video collaboration seamlessly into your Android applications."/>
</head>
